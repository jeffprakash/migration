...
class Placement(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE,to_field='c_name', null=True)
    sil=models.ForeignKey(Company, on_delete=models.CASCADE,to_field='unique_id', null=True,db_constraint=False,db_index=False)
